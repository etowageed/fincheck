<template>
    <div class="min-h-screen bg-tertiary py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto bg-primary shadow rounded-lg p-8 border border-default">
            <h1 class="text-3xl font-bold text-primary mb-6">Terms of Service</h1>
            <div class="prose  max-w-none text-secondary space-y-4">
                ...
                <h2 class="text-xl font-semibold text-primary mt-6">4. Privacy Policy</h2>
                <p>Your use of the service is also governed by our Privacy Policy. Please review our Privacy Policy to
